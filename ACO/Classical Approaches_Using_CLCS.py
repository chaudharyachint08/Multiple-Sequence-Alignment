...
file = open(input('Enter File Containing DNA Sequences to be aligned using Classical CLCS\n'))
...
consensus = mat3[0]
print('CLCS Based Greedy Approach with length',len(consensus),'\n',consensus)
...
print('\nCLCS Based Greedy from LAST Approach with length',len(consensus),'\n',consensus)
'''
...
print('\nCLCS Based Tournament Approach with length',len(consensus),'\n',consensus)
